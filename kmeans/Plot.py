...
if __name__ == "__main__":
    duckdb_file = './DuckDB_Kmeans_Results.csv'
    umbra_file = './Umbra_Kmeans_Results.csv'
    postgres_file = './Postgres_Kmeans_Results.csv'
    scenario_name = 'Kmeans'
    line_keys = ['Type']
    x_keys = ['Points']
