...
def main():
    ...
    for scenario in scenarios:
        ...
        slope, intercept = CONFIG['slope'], CONFIG['intercept']
        generate_points(scenario['p_amount'], slope, intercept)
        for database in databases:
            if database['ignore']:
                continue
...
def generate_points(number: int, slope: float, intercept: float) -> List[List[float]]:
    '''
