...
def plot_data(data: dict, x_label: str, y_label: str, file_name: str, legend_loc: str = 'lower left', x_as_log: bool = True, y_as_log: bool = False) -> None:
    ...
    description = []
    for key, value in data.items():
        handles.append(Line2D([0], [0], color=value['color'], linestyle=value['style'], marker=value['marker'], linewidth=2))
    ...
    # Optionally, save the legend to a file
    #plt.savefig('legend_only.png', bbox_inches='tight', transparent=True)
